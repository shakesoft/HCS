...
public class HCMenuContributor : IMenuContributor
{
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        context.Menu.AddItem(new ApplicationMenuItem("Projects", l["Menu:Projects"], icon: "fa fa-diagram-project", order: 4).AddItem(new ApplicationMenuItem("Projects.List", l["Menu:ProjectList"], url: "/projects").RequirePermissions(HCPermissions.Projects.Default))
                    .AddItem(new ApplicationMenuItem("Tasks.List", l["Menu:Tasks"], url: "/tasks").RequirePermissions(HCPermissions.Tasks.Default)));
        ...
        .AddItem(new ApplicationMenuItem("MasterDatas.IssuingAuthority", l["IssuingAuthority"], url: "/units").RequirePermissions(HCPermissions.MasterDatas.UnitDefault))
        .AddItem(new ApplicationMenuItem("MasterDatas.Unit", l["Unit"], url: "/units").RequirePermissions(HCPermissions.MasterDatas.UnitDefault))
        ...
        .AddItem(new ApplicationMenuItem("Reports.Documents", l["Documents"], url: "/reports-documents").RequirePermissions(HCPermissions.Reports.DocumentDefault))
        .AddItem(new ApplicationMenuItem("Reports.Projects", l["Projects"], url: "/reports-projects").RequirePermissions(HCPermissions.Reports.ProjectDefault))
        .AddItem(new ApplicationMenuItem("Reports.ProjectTasks", l["ProjectTasks"], url: "/reports-project-tasks").RequirePermissions(HCPermissions.Reports.ProjectTaskDefault)).AddItem(new ApplicationMenuItem("Reports.Workflows", l["Workflows"], url: "/reports-workflows").RequirePermissions(HCPermissions.Reports.WorkflowDefault)));
