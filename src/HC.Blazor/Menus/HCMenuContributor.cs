...
public class HCMenuContributor : IMenuContributor
{
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        context.Menu.AddItem(new ApplicationMenuItem("Personal", l["Menu:Personal"], icon: "fa fa-users", order: 5).AddItem(new ApplicationMenuItem("Users.Signatures", l["Menu:Signatures"], url: "/user-signatures").RequirePermissions(HCPermissions.UserSignatures.Default))// .AddItem(new ApplicationMenuItem("Users.UserDepartments", l["Menu:UserDepartments"], url: "/user-departments").RequirePermissions(HCPermissions.Departments.Default))
        );
        ...
        .AddItem(new ApplicationMenuItem("MasterDatas.UrgencyLevel", l["UrgencyLevel"], url: "/urgency-levels").RequirePermissions(HCPermissions.MasterDatas.UrgencyLevelDefault))
        .AddItem(new ApplicationMenuItem("MasterDatas.ConfidentialityLevel", l["ConfidentialityLevel"], url: "/confidentiality-levels").RequirePermissions(HCPermissions.MasterDatas.ConfidentialityLevelDefault))
        .AddItem(new ApplicationMenuItem("MasterDatas.ProcessingMethod", l["ProcessingMethod"], url: "/processing-methods").RequirePermissions(HCPermissions.MasterDatas.ProcessingMethodDefault))
        .AddItem(new ApplicationMenuItem("MasterDatas.DocumentStatus", l["DocumentStatus"], url: "/document-status").RequirePermissions(HCPermissions.MasterDatas.DocumentStatusDefault))
        .AddItem(new ApplicationMenuItem("MasterDatas.SigningMethod", l["SigningMethod"], url: "/signing-methods").RequirePermissions(HCPermissions.MasterDatas.SigningMethodDefault))
        .AddItem(new ApplicationMenuItem("MasterDatas.EventType", l["EventType"], url: "/even-types").RequirePermissions(HCPermissions.MasterDatas.EventTypeDefault))
        ...
        .AddItem(new ApplicationMenuItem("MasterDatas.Unit", l["Unit"], url: "/unit-lists").RequirePermissions(HCPermissions.MasterDatas.UnitDefault))
        .AddItem(new ApplicationMenuItem("MasterDatas.Departments", l["Menu:Departments"], url: "/departments").RequirePermissions(HCPermissions.MasterDatas.DepartmentDefault))
        .AddItem(new ApplicationMenuItem("MasterDatas.Positions", l["Menu:Positions"], url: "/positions").RequirePermissions(HCPermissions.MasterDatas.PositionDefault))
        .AddItem(new ApplicationMenuItem("MasterDatas.SurveyLocations", l["Menu:SurveyLocations"], url: "/survey-locations").RequirePermissions(HCPermissions.MasterDatas.SurveyLocationDefault))
        .AddItem(new ApplicationMenuItem("MasterDatas.SurveyCriterias", l["Menu:SurveyCriterias"], url: "/survey-criterias").RequirePermissions(HCPermissions.MasterDatas.SurveyCriteriaDefault)).AddItem(new ApplicationMenuItem("MasterDatas.SignatureSettings", l["Menu:SignatureSettings"], url: "/signature-settings").RequirePermissions(HCPermissions.MasterDatas.SignatureSettingsDefault)));
