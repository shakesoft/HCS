...
public class HCMenuContributor : IMenuContributor
{
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        .AddItem(new ApplicationMenuItem("Workflows.List", l["Menu:WorkflowList"], url: "/workflows").RequirePermissions(HCPermissions.Workflows.Default))
        .AddItem(new ApplicationMenuItem("Workflows.WorkflowTemplates", l["Menu:WorkflowTemplates"], url: "/workflow-templates").RequirePermissions(HCPermissions.WorkflowTemplates.Default))
        .AddItem(new ApplicationMenuItem("Workflows.WorkflowStepTemplates", l["Menu:WorkflowStepTemplates"], url: "/workflow-step-templates").RequirePermissions(HCPermissions.WorkflowStepTemplates.Default))
        .AddItem(new ApplicationMenuItem("Workflows.WorkflowStepAssignments", l["Menu:WorkflowStepAssignments"], url: "/workflow-step-assignments").RequirePermissions(HCPermissions.WorkflowStepAssignments.Default))
        .AddItem(new ApplicationMenuItem("Workflows.Follow", l["Workflows.Follow"], url: "/workflows").RequirePermissions(HCPermissions.Workflows.Default)));
        ...
        context.Menu.AddItem(new ApplicationMenuItem("CalendarAndEvents", l["Menu:CalendarAndEvents"], icon: "fa fa-calendar-days", order: 6)
        .AddItem(new ApplicationMenuItem("CalendarAndEvents.CalendarAndEvents", l["Menu:CalendarAndEvents"], url: "/calendar-events").RequirePermissions(HCPermissions.CalendarEvents.Default)));
