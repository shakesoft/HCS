...
public class HCMenuContributor : IMenuContributor
{
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        .AddItem(new ApplicationMenuItem("Workflows.WorkflowDefinitions", l["Menu:WorkflowDefinitions"], url: "/workflow-definitions").RequirePermissions(HCPermissions.WorkflowDefinitions.Default))
        .AddItem(new ApplicationMenuItem("Workflows.List", l["Menu:WorkflowList"], url: "/workflow-lists").RequirePermissions(HCPermissions.Workflows.Default)));
        ...
        context.Menu.AddItem(new ApplicationMenuItem("SurveyResults", l["Menu:SurveyResults"], icon: "fa fa-chart-line", order: 6)
        .AddItem(new ApplicationMenuItem("SurveyResults.SurveyResults", l["Menu:SurveyResults"], url: "/survey-results")
        .RequirePermissions(HCPermissions.SurveyResults.Default)));


        context.Menu.AddItem(new ApplicationMenuItem("MasterDatas", l["Menu:Categories"], icon: "fa fa-layer-group", order: 9)
        .AddItem(new ApplicationMenuItem("MasterDatas.DocumentTypes", l["DocumentTypes"], url: "/document-types").RequirePermissions(HCPermissions.MasterDatas.DocumentTypeDefault)).AddItem(new ApplicationMenuItem("MasterDatas.Sector", l["Sector"], url: "/sectors").RequirePermissions(HCPermissions.MasterDatas.SectorDefault))
        // .AddItem(
        ...
        .AddItem(new ApplicationMenuItem("MasterDatas.SurveyCriterias", l["Menu:SurveyCriterias"], url: "/survey-criterias").RequirePermissions(HCPermissions.MasterDatas.SurveyCriteriaDefault))
        .AddItem(new ApplicationMenuItem("MasterDatas.SignatureSettings", l["Menu:SignatureSettings"], url: "/signature-settings").RequirePermissions(HCPermissions.MasterDatas.SignatureSettingsDefault))
