...
public class HCMenuContributor : IMenuContributor
{
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        //  .AddItem(new ApplicationMenuItem("ProjectTasks.ProjectTaskByProjects", l["Menu:ProjectTaskByProjects"], url: "/project-tasks-by-project").RequirePermissions(HCPermissions.Projects.Default))
        //  .AddItem(new ApplicationMenuItem("ProjectTasks.ProjectTaskDetail", l["Menu:ProjectTaskDetail"], url: "/project-tasks-details").RequirePermissions(HCPermissions.Projects.Default)));
