...
public abstract class EfCoreSignatureSettingRepositoryBase : EfCoreRepository<HCDbContext, SignatureSetting, Guid>
{
    ...
    public virtual async Task DeleteAllAsync(string? filterText = null, string? providerCode = null, string? providerType = null, string? apiEndpoint = null, int? apiTimeoutMin = null, int? apiTimeoutMax = null, string? defaultSignType = null, bool? allowElectronicSign = null, bool? allowDigitalSign = null, bool? requireOtp = null, int? signWidthMin = null, int? signWidthMax = null, int? signHeightMin = null, int? signHeightMax = null, string? signedFileSuffix = null, bool? keepOriginalFile = null, bool? overwriteSignedFile = null, bool? enableSignLog = null, bool? isActive = null, CancellationToken cancellationToken = default)
    {
    ...
    public virtual async Task<long> GetCountAsync(string? filterText = null, string? providerCode = null, string? providerType = null, string? apiEndpoint = null, int? apiTimeoutMin = null, int? apiTimeoutMax = null, string? defaultSignType = null, bool? allowElectronicSign = null, bool? allowDigitalSign = null, bool? requireOtp = null, int? signWidthMin = null, int? signWidthMax = null, int? signHeightMin = null, int? signHeightMax = null, string? signedFileSuffix = null, bool? keepOriginalFile = null, bool? overwriteSignedFile = null, bool? enableSignLog = null, bool? isActive = null, CancellationToken cancellationToken = default)
    {
    ...
    protected virtual IQueryable<SignatureSetting> ApplyFilter(IQueryable<SignatureSetting> query, string? filterText = null, string? providerCode = null, string? providerType = null, string? apiEndpoint = null, int? apiTimeoutMin = null, int? apiTimeoutMax = null, string? defaultSignType = null, bool? allowElectronicSign = null, bool? allowDigitalSign = null, bool? requireOtp = null, int? signWidthMin = null, int? signWidthMax = null, int? signHeightMin = null, int? signHeightMax = null, string? signedFileSuffix = null, bool? keepOriginalFile = null, bool? overwriteSignedFile = null, bool? enableSignLog = null, bool? isActive = null)
    {
        return query.WhereIf(!string.IsNullOrWhiteSpace(filterText), e => e.ProviderCode!.Contains(filterText!) || e.ProviderType!.Contains(filterText!) || e.ApiEndpoint!.Contains(filterText!) || e.DefaultSignType!.Contains(filterText!) || e.SignedFileSuffix!.Contains(filterText!)).WhereIf(!string.IsNullOrWhiteSpace(providerCode), e => e.ProviderCode.Contains(providerCode)).WhereIf(!string.IsNullOrWhiteSpace(providerType), e => e.ProviderType.Contains(providerType)).WhereIf(!string.IsNullOrWhiteSpace(apiEndpoint), e => e.ApiEndpoint.Contains(apiEndpoint)).WhereIf(apiTimeoutMin.HasValue, e => e.ApiTimeout >= apiTimeoutMin!.Value).WhereIf(apiTimeoutMax.HasValue, e => e.ApiTimeout <= apiTimeoutMax!.Value).WhereIf(!string.IsNullOrWhiteSpace(defaultSignType), e => e.DefaultSignType.Contains(defaultSignType)).WhereIf(allowElectronicSign.HasValue, e => e.AllowElectronicSign == allowElectronicSign).WhereIf(allowDigitalSign.HasValue, e => e.AllowDigitalSign == allowDigitalSign).WhereIf(requireOtp.HasValue, e => e.RequireOtp == requireOtp).WhereIf(signWidthMin.HasValue, e => e.SignWidth >= signWidthMin!.Value).WhereIf(signWidthMax.HasValue, e => e.SignWidth <= signWidthMax!.Value).WhereIf(signHeightMin.HasValue, e => e.SignHeight >= signHeightMin!.Value).WhereIf(signHeightMax.HasValue, e => e.SignHeight <= signHeightMax!.Value).WhereIf(!string.IsNullOrWhiteSpace(signedFileSuffix), e => e.SignedFileSuffix.Contains(signedFileSuffix)).WhereIf(keepOriginalFile.HasValue, e => e.KeepOriginalFile == keepOriginalFile).WhereIf(overwriteSignedFile.HasValue, e => e.OverwriteSignedFile == overwriteSignedFile).WhereIf(enableSignLog.HasValue, e => e.EnableSignLog == enableSignLog).WhereIf(isActive.HasValue, e => e.IsActive == isActive);
    }
}