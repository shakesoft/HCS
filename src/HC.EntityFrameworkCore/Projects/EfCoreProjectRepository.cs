...
public abstract class EfCoreProjectRepositoryBase : EfCoreRepository<HCDbContext, Project, Guid>
{
    ...
    protected virtual IQueryable<ProjectWithNavigationProperties> ApplyFilter(IQueryable<ProjectWithNavigationProperties> query, string? filterText, string? code = null, string? name = null, string? description = null, DateTime? startDateMin = null, DateTime? startDateMax = null, DateTime? endDateMin = null, DateTime? endDateMax = null, ProjectStatus? status = null, Guid? ownerDepartmentId = null)
    {
        return query
            ...
            .WhereIf(status.HasValue, e => e.Project.Status == status)
    ...
    protected virtual IQueryable<Project> ApplyFilter(IQueryable<Project> query, string? filterText = null, string? code = null, string? name = null, string? description = null, DateTime? startDateMin = null, DateTime? startDateMax = null, DateTime? endDateMin = null, DateTime? endDateMax = null, ProjectStatus? status = null)
    {
        return query
            .WhereIf(!string.IsNullOrWhiteSpace(filterText), e => 
