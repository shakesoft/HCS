...
public partial interface INotificationReceiverRepository : IRepository<NotificationReceiver, Guid>
{
    ...
    Task<long> GetCountAsync(string? filterText = null, bool? isRead = null, DateTime? readAtMin = null, DateTime? readAtMax = null, Guid? notificationId = null, Guid? identityUserId = null, CancellationToken cancellationToken = default);
}