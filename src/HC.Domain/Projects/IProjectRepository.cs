...
public partial interface IProjectRepository : IRepository<Project, Guid>
{
    ...
    Task<long> GetCountAsync(string? filterText = null, string? code = null, string? name = null, string? description = null, DateTime? startDateMin = null, DateTime? startDateMax = null, DateTime? endDateMin = null, DateTime? endDateMax = null, ProjectStatus? status = null, Guid? ownerDepartmentId = null, CancellationToken cancellationToken = default);
}