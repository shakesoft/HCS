...
{
    Task DeleteAllAsync(string? filterText = null, int? orderMin = null, int? orderMax = null, string? name = null, string? type = null, int? sLADaysMin = null, int? sLADaysMax = null, bool? isActive = null, Guid? workflowTemplateId = null, CancellationToken cancellationToken = default);
    ...
    Task<long> GetCountAsync(string? filterText = null, int? orderMin = null, int? orderMax = null, string? name = null, string? type = null, int? sLADaysMin = null, int? sLADaysMax = null, bool? isActive = null, Guid? workflowTemplateId = null, CancellationToken cancellationToken = default);
}