...
public class DocumentAssignmentsAppService : DocumentAssignmentsAppServiceBase, IDocumentAssignmentsAppService
{
    ...
    public override async Task DeleteAsync(Guid id)
    {
        ...
        var step = assignmentWithNav.Step;
        ...
        var notification = new Notification(
            ...
            notificationContentKey,
            SourceType.WORKFLOW.ToString(),
            EventType.WORKFLOW_ASSIGN_REMOVED.ToString(),
            RelatedType.DOCUMENT.ToString(),
            "NORMAL",
            document.Id.ToString()
        );
        ...
        await _distributedEventBus.PublishAsync(
            ...
            {
                NotificationId = notification.Id,
                ReceiverUserIds = new List<Guid> { receiverUser.Id }
            }
        );
    }
    ...
    public override async Task<DocumentAssignmentDto> UpdateAsync(Guid id, DocumentAssignmentUpdateDto input)
    {
        ...
        var notification = new Notification(
            ...
            notificationContentKey,
            SourceType.WORKFLOW.ToString(),
            EventType.WORKFLOW_ASSIGN_UPDATED.ToString(),
            RelatedType.DOCUMENT.ToString(),
            "NORMAL",
            document.Id.ToString()
        );
